...
function checkAnswer(index){
  // Menggunakan window.questionsData sebagai ganti JSON.stringify langsung
...
// 🔥 TAMBAHAN: Event Listener untuk Tombol Kirim Jawaban
...
// 🔥 TAMBAHAN: Listener di file utama untuk menyimpan nilai siswa ke Firebase
window.addEventListener("message", async (event) => {
  if (event.data && event.data.type === "SUBMIT_EXERCISE") {
    ...
    try {
      ...
      // Menyimpan data ke koleksi student_scores
